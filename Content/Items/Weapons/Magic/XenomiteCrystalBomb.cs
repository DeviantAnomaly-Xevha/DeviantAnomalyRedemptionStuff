...
namespace DeviantAnomalyRedemptionStuff.Content.Items.Weapons.Magic
{
    ...
    {
        public float Charge;
        public static readonly SoundStyle CrystalBomb_shot = new SoundStyle("DeviantAnomalyRedemptionStuff/Sounds/CrystalBomb/CrystalBomb_shot");
        public static readonly SoundStyle CrystalBomb_ChargeLv1 = new SoundStyle("DeviantAnomalyRedemptionStuff/Sounds/XenomiteWeapon_Lv1Charge");
        public static readonly SoundStyle CrystalBomb_ChargeLv2 = new SoundStyle("DeviantAnomalyRedemptionStuff/Sounds/XenomiteWeapon_Lv2Charge");
        public static readonly SoundStyle CrystalBomb_ChargeLv3 = new SoundStyle("DeviantAnomalyRedemptionStuff/Sounds/XenomiteWeapon_Lv3Charge");
            ...
            if (!player.channel && Charge > 30f)
            {
                ...
                else if (player.statMana >= Item.mana)
                {
                    ...
                    if (Charge >= 180f && player.statMana >= Item.mana * 3)
                    {
                        ...
                        Projectile.NewProjectile(Projectile.InheritSource(player), player.Center, new Vector2((AimDirection.X * Item.shootSpeed) * .625f, (AimDirection.Y - 11f) * player.gravDir), Mod.Find<ModProjectile>("XenomiteCrystalBombCharged_Proj").Type, Item.damage * 3, 0, Main.myPlayer);
                    }
                }
            }
        }
        ...
        public override void AddRecipes()
        {
            if (ModLoader.TryGetMod("Redemption", out var otherMod))
            {
                if (otherMod.TryFind<ModItem>("XenomiteItem", out var modItemName) && otherMod.TryFind<ModItem>("Bioweapon", out var modItemName2) && otherMod.TryFind<ModItem>("ToxicBile", out var modItemName3))
                {
                    CreateRecipe()
                        ...
                        .AddIngredient(modItemName.Type, 5)
                        .AddRecipeGroup("DeviantAnomalyRedemptionStuff:Adamantite or Titanium Bar", 5)
                        .AddRecipeGroup("Redemption:BioweaponBile", 5)
                        .AddTile(TileID.MythrilAnvil)
                        .Register();
                }
            }
            else
            {
                CreateRecipe()
                    ...
                    //I don't want to be a pain with setting this part to 30, but I also don't want tier 4 to be so quick directly after tier 3...
                    //...unless someone collects 30 Cursed Flame/Ichor ahead of time. That's just them being smart, or a hoarder. Good for them, I guess.
                    //At least that stuff has a higher drop rate than Bio-Weapon or Toxic Bile.
                    .AddTile(TileID.MythrilAnvil)
                    .Register();
            }
        }

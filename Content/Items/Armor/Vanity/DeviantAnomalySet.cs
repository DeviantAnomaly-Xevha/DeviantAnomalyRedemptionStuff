...
namespace DeviantAnomalyRedemptionStuff.Content.Items.Armor.Vanity
{
    ...
    public class DeviantAnomalyLegs : ModItem
    {
        ...
        {
            if (!male) equipSlot = DeviantAnomalyRedemptionStuff.xevhaFemLegID;
            if (male) equipSlot = DeviantAnomalyRedemptionStuff.xevhaMaleLegID;
        }
        public override void AddRecipes()
        {
            if (ModLoader.TryGetMod("Redemption", out var otherMod))

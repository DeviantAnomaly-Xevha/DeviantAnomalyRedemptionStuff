...
{
    public class XenomiteCrystalPillar_1_2_Proj : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.InheritSource(Projectile), new Vector2(Projectile.Center.X, Projectile.Center.Y - 16f), new Vector2(0f - Main.rand.Next(1, 4), 0f - Main.rand.Next(1, 4)), Mod.Find<ModProjectile>($"XenomiteCrystalPillarShard{Main.rand.Next(1, 5)}_Proj").Type, 0, 0, Main.myPlayer);
            Projectile.NewProjectile(Projectile.InheritSource(Projectile), new Vector2(Projectile.Center.X, Projectile.Center.Y - 16f), new Vector2(0f - Main.rand.Next(1, 2), 0f - Main.rand.Next(1, 12)), Mod.Find<ModProjectile>($"XenomiteCrystalPillarShard{Main.rand.Next(1, 5)}_Proj").Type, 0, 0, Main.myPlayer);
            Projectile.NewProjectile(Projectile.InheritSource(Projectile), new Vector2(Projectile.Center.X, Projectile.Center.Y - 16f), new Vector2(0f + Main.rand.Next(1, 2), 0f - Main.rand.Next(1, 12)), Mod.Find<ModProjectile>($"XenomiteCrystalPillarShard{Main.rand.Next(1, 5)}_Proj").Type, 0, 0, Main.myPlayer);
            Projectile.NewProjectile(Projectile.InheritSource(Projectile), new Vector2(Projectile.Center.X, Projectile.Center.Y - 16f), new Vector2(0f + Main.rand.Next(1, 4), 0f - Main.rand.Next(1, 4)), Mod.Find<ModProjectile>($"XenomiteCrystalPillarShard{Main.rand.Next(1, 5)}_Proj").Type, 0, 0, Main.myPlayer);
        }
